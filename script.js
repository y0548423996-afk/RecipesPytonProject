        ...
        <div class="recipe-card" onclick="viewRecipe(${recipe.id})">
            ...
            <div class="recipe-content">
                ...
                <div class="recipe-actions">
                    <span class="btn-view-main">צפו במתכון ✨</span>
                    <button class="btn-action edit" onclick="event.stopPropagation(); editRecipe(${recipe.id})">✏️</button>
                    <button class="btn-action delete" onclick="event.stopPropagation(); deleteRecipe(${recipe.id})">🗑️</button>
                </div>
            </div>
        </div>
    `).join('');
...
async function editRecipe(id) {
    try {
        ...
        const titleElement = form.querySelector('.form-title');
        if (titleElement) titleElement.textContent = 'עריכת מתכון: ' + (recipe.name || 'ללא שם');
